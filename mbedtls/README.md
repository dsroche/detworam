...
This is version 2.4.2 of the mbed TLS library, released 2017-03-08
and downloaded from <https://tls.mbed.org/download>. The files relevant
for the `detworam` package are selectively included here, without
modification. The only changes or additions are this preamble to
the original `README` file, as well as the `Makefile`.
